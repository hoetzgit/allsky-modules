...
class ALLSKYPUBLISHDATARETAIN(ALLSKYMODULEBASE):
    
	meta_data = {
		"name": "Publish Data to Redis/MQTT/REST/influxDB",
		"description": "Publish Allsky data to Redis, MQTT, REST, or influxDB (MQTT retain Flag is possible)",
		"module": "allsky_publishdata_retain",
		"version": "v1.0.6",
      ...
      "mqttSelfSigned": "",
		...
		"changelog": {
			...
			"v1.0.6" : [
				{
					"author": "Henry Ott",
					"authorurl": "https://github.com/hoetzgit",
					"changes": [
						"Added MQTT retain flag option (mqttRetain)"
					]
				}
			]   
		}    
	...
	def _send_to_mqtt(self):
		...
		mqtt_retain = self.get_param('mqttRetain', True, bool)    
